...
///
/// [Container.bordered] - provides border to the container.
/// [Container.rounded] - provides rounded shape to the container for the given height and width of the container.
...
class AppContainer extends StatelessWidget {
  ...
  const AppContainer.transparent(
      {Key? key,
      this.child,
      this.borderRadius,
      this.padding,
  ...
  const AppContainer.roundBordered(
      {Key? key,
      this.child,
      this.borderRadius,
      this.padding,
              ...
              ? (shape == BoxShape.rectangle
                  ? borderRadius ??
                      BorderRadius.all(Radius.circular(
                          borderRadiusAll ?? constants.containerRadius))
                  : null)
              : null,
          border: bordered
              ? border ??
                  Border.all(
                      color: borderColor ?? colors.appDividerColor, width: 1)
              : null),
